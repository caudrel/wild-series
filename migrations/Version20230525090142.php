 ...
 */
final class Version20230525090142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD CONSTRAINT FK_92ED77841E5D0459 FOREIGN KEY (test_id) REFERENCES category (id)');
